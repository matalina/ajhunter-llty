export const prompts = [
  ...
  { prompt: "Describe a location using only the sense of smell" },
  { prompt: "Describe a location using only the sense of taste" },
  { prompt: "Describe a location using only the sense of hearing" },
  { prompt: "Describe a location using only the sense of touch" },
  { prompt: "Describe a location using only the sense of sight" },
  { prompt: "Describe a location using all the senses" },
  { prompt: "Describe an object using only the sense of smell" },
  { prompt: "Describe an object using only the sense of taste" },
  { prompt: "Describe an object using only the sense of hearing" },
  { prompt: "Describe an object using only the sense of touch" },
  { prompt: "Describe an object using only the sense of sight" },
